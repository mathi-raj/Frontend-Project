...
import { Viewregisterprofilepopup01 } from './Viewregisterprofilepopup01'
import KeyboardBackspaceRoundedIcon from '@mui/icons-material/KeyboardBackspaceRounded';
import FaceRoundedIcon from '@mui/icons-material/FaceRounded';
import { useNavigate } from 'react-router-dom'

export const Viewregisterprofilepopup02 = () => {
  ...
  return (
    ...
    <div className='Viewregisterprofile01'>
        ...
        <div className='profilebutton'>
            ...
            <button className='profilepopupbut2' onClick={()=>Navigate("/Viewregisterprofilepopup01")}>Edit</button>
        </div>
    </div>
   </div>

   {/* <Viewregisterprofilepopup01/> */}
